...
@EntityScan(basePackages = ["org.depromeet.cllog.server.domain", "org.depromeet.cllog.server.infrastructure"])
@EnableJpaRepositories(basePackages = ["org.depromeet.cllog.server"])
